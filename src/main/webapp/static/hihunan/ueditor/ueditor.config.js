...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       /* , toolbars:[
            ['source', '|', 'undo', 'redo', '|',
                'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'autotypeset', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc', '|',
                'rowspacingtop', 'rowspacingbottom', 'lineheight', '|',
                'customstyle', 'paragraph', 'fontfamily', 'fontsize', '|',
                'directionalityltr', 'directionalityrtl', 'indent', '|',
                'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 'touppercase', 'tolowercase', '|',
                'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|',
                'uploadimage','uploadfile','uploadvideo','insertchannel','|', 'pagebreak', 'horizontal', 'date', 'time', 'spechars', '|',
        ...
        , toolbars:[
                    [ 'undo', 'redo', '|', 'bold', 'italic', 'underline','removeformat', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist','|',
                        'rowspacingtop', 'rowspacingbottom', 'lineheight', '|',
        ...
        ,labelMap:{
            'anchor':'', 'undo':'', 'uploadimage':'图片', 'uploadfile':'附件','uploadvideo':'视频','insertchannel':'插入栏目'
        }
        //webAppKey
