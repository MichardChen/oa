...
// 			}
    	...
    	function addTabFmPage($this,name,refresh,urlparam){
		    ...
		    // 如果已经打开，则激活或者重新加载数据。
		    var activateFlag;
		    activateFlag =   activateOpenTab(name,needReload,parm);
		    if(activateFlag=="1"){
                   return false;
	        }
	...
	<div id="main">
			...
			<div class="navbar-inner">
				...
				<ul id="userControl" class="nav pull-right">
					...
					<li id="themeSwitch" class="dropdown">
						<a class="dropdown-toggle" data-toggle="dropdown" href="#" title="主题切换"  style="color:white;"><i class="icon-th-large"></i></a>
					...
					<li id="userInfo" class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="${ctx}/ns/sysMessageHist/myMessage" target="mainFrame"><i class="icon-bell"></i>&nbsp;  我的消息 <span id="notifyNum2" class="label label-info hide"></span></a></li>
						</ul>
					</li>
				...
				<div class="nav-collapse">
					<ul id="menu" class="nav" style="*white-space:nowrap;float:none;">
						...
						<c:forEach items="${fns:getMenuList()}" var="menu" varStatus="idxStatus">
							<c:if test="${menu.parent.id eq '1' && menu.isShow eq '1' && menu.media eq 'pc'}">
	    ...
	    <div class="container-fluid">
			<div id="content" class="row-fluid">
				...
				<div id="right" style="border: 1px solid #d2d2d2">
					<iframe id="mainFrame" name="mainFrame" src="" style="overflow:visible;" scrolling="yes" frameborder="no" width="100%" height="650"></iframe>
				</div>
			</div>
		    <div id="footer" class="row-fluid" style="color: #626567;">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} <!-- Powered By <a href="http://www.xmhold.com" target="_blank">XMHOLD</a> ${fns:getConfig('version')} -->
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
