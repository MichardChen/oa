		...
		<div class="control-group">
			...
			<div class="controls">
                <sys:treeselect id="category" name="category.id" value="${link.category.id}" labelName="category.name" labelValue="${link.category.name}"
					title="栏目" url="/cms/category/treeData" module="link" selectScopeModule="true" notAllowSelectRoot="false" notAllowSelectParent="true" cssClass="required" containerId="inputForm"/>
			</div>
		</div>
		<div class="control-group">
