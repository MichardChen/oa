package com.thinkgem.jeesite.modules.task.scrapynews;  
...
{  
     ...
     * 匹配超链接的正则表达式  
     */ 
    private static String pat = "<a target=\"_blank\" class=\"pic\" href=\"([^\"]*)\"><img class=\"picto\" src=\"([^\"]*)\"></a><em class=\"f14 l24\"><a target=\"_blank\" class=\"linkto\" href=\"[^\"]*\">([^</a>]*)</a></em><p class=\"l22\">([^</p>]*)</p>";  
