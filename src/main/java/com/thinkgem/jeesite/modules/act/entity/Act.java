...
public class Act extends BaseEntity<Act>{
	...
	private String initiatorName; // 任务发起者名字
	private String initiatorUserId; // 任务发起者的UserId. 如 u_234

	private String title; // 任务标题
	private String curUserId; // 上一环节的用户Id
	...
	private HistoricProcessInstance histProc;
	...
	private String nsAreaName;// 片区（农商行系统）

	private String nsAreaId;// 片区Id（农商行系统）
	...
	@JsonIgnore
	public HistoricProcessInstance getHistProc() {
		return histProc;
	}

	public void setHistProc(HistoricProcessInstance histProc) {
		this.histProc = histProc;
	}
	...
	public String getNsAreaName() {
		return nsAreaName;
	}

	public void setNsAreaName(String nsAreaName) {
		this.nsAreaName = nsAreaName;
	}

	public String getNsAreaId() {
		return nsAreaId;
	}

	public void setNsAreaId(String nsAreaId) {
		this.nsAreaId = nsAreaId;
	}
