...
import com.fastweixin.api.response.GetMaterialListResponse;
import com.fastweixin.api.response.GetMaterialTotalCountResponse;
import com.fastweixin.api.response.UploadMaterialResponse;
...
public class MaterialAPI extends BaseAPI {
     ...
     * @return 下载结果
     */
    public DownloadMaterialResponse downloadTempMaterial(String mediaId, MaterialType type){
        DownloadMaterialResponse response = new DownloadMaterialResponse();
