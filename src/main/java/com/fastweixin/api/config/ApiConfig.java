...
public final class ApiConfig extends Observable implements Serializable {
	...
	private static final long serialVersionUID = 7921381917651465031L;
    ...
    private static String  appid = DictUtils.getDictLabel("appid",  "weixinApp", ""); // 从sys_Dict中获取appid "wxee723b0730e3f7c7";
    private static String  secret= DictUtils.getDictLabel("secret", "weixinApp", ""); // 从sys_Dict中获取secret "c461db1178f74dafae3a6ee2e802d1c3";
    private static String  accessToken;
    private static String  jsApiTicket;
    private static boolean enableJsApi           = true;
    private static  long    jsTokenStartTime     = 0;
    private static  long    weixinTokenStartTime = 0;
    ...
    public String getJsApiTicket() {
        if (enableJsApi) {
            ...
            try {
                ...
                if (now - this.jsTokenStartTime > CACHE_TIME && this.jsRefreshing.compareAndSet(false, true)) {
                    getAccessToken();
                    initJSToken(now);
                }
            } catch (Exception e) {
