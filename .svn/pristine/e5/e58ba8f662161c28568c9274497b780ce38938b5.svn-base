...
UE.plugins['lineheight'] = function(){
    ...
    me.commands['lineheight'] =  {
        execCommand : function( cmdName,value ) {
            this.execCommand('paragraph','p',{style:'line-height:'+ (value == "1.5" ? "normal" : value + 'em') });
            return true;
        },
        queryCommandValue : function() {
            var pN = domUtils.filterNodeList(this.selection.getStartElementPath(),function(node){return domUtils.isBlockElm(node)});
            if(pN){
                ...
                return value == 'normal' ? 1.5 : value.replace(/[^\d.]*/ig,"");
            }
        }
    };
};
    ...
    Popup.prototype = {
        ...
        postRender: function (){
            ...
            if( this.captureWheel && !this.captured ) {
                ...
                var winHeight = Math.max((this.editor.document.documentElement.clientHeight || this.editor.document.body.clientHeight),100),
                    _height = this.getDom().offsetHeight,
                  //_top = domUtils.getXY( this.combox.getDom() ).y,
                    _top = 0;//domUtils.getXY( this.combox.getDom() ).y,
...
(function () {
    ...
    var btnCmds = ['undo', 'redo', 'formatmatch',
        ...
        'uploadimage','uploadfile','uploadvideo','insertchannel'];
