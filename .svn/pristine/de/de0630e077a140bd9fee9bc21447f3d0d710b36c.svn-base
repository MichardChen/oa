...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		var p = $.extend(true,{
			...
			sortorder: "asc",
			sortname: "",
			sorttype: "", // add by ht-wzf 20150324
			datatype: "xml",
			mtype: "GET",
			altRows: false,
			selarrrow: [],
			...
			prmNames: {page:"page",rows:"rows", sort: "sidx",order: "sord",stype:"stype", search:"_search", nd:"nd", id:"id",oper:"oper",editoper:"edit",addoper:"add",deloper:"del", subgridid:"id", npage: null, totalrows:"totalrows"}, // modify by ht-wzf 20150324
			forceFit : false,
			gridstate : "visible",
			cellEdit: false,
			cellsubmit: "remote",
		...
		populate = function (npage) {
			if(!ts.grid.hDiv.loading) {
				...
				if(pN.stype !== null) {prm[pN.stype]= ts.p.sorttype;} // modify by ht-wzf 20150324
		...
		sortData = function (index, idxcol,reload,sor){
			...
			ts.p.sorttype = ts.p.colModel[idxcol].sorttype; // add by ht-wzf 20150324
			so = ts.p.sortorder;
