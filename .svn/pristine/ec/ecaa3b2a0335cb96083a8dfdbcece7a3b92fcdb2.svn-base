...
public final class QYAPIConfig extends Observable implements Serializable {
	...
	private static final long serialVersionUID = 4046157880381080413L;
    ...
    private static String  corpid     = DictUtils.getDictLabel("appid",  "qyWeixinApp", "");
    private static String  corpsecret = DictUtils.getDictLabel("secret", "qyWeixinApp", "");
    ...
    // 单例模式
    private static QYAPIConfig instance = new QYAPIConfig();
    public static QYAPIConfig getInstance(){
    	return instance;
    }
    // 单例模式用构造函数
    private QYAPIConfig(){
