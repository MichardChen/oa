...
var Core = function(options) {
   ...
   var runHelpers = function() {
      ...
      //2016/1/6 yuyabiao下拉框采用select2风格
      //$("select").select2();
   }
   ...
   var runSideMenu = function(options) {
      ...
      var sidebarLeftToggle = function() {
    	 ...
    	 // 20151214 remove. 使画面打开后，左侧菜单处于缩回的状态。 
      ...
      // Functions Calls
      sbOnLoadCheck();
      $("#toggle_sidemenu_l").click(sidebarLeftToggle); // 20151214 remove 左侧菜单的切换。
